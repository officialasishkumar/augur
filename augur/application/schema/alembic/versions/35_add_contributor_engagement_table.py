...
def upgrade():
    op.create_table(
        ...
        sa.Column("d0_engagement_timestamp", sa.TIMESTAMP(precision=6), nullable=True),
        # D1 Level - Issue/Review Engagement
        sa.Column(
            "d1_first_issue_created_at", sa.TIMESTAMP(precision=6), nullable=True
        ),
        sa.Column("d1_first_pr_opened_at", sa.TIMESTAMP(precision=6), nullable=True),
        sa.Column("d1_first_pr_commented_at", sa.TIMESTAMP(precision=6), nullable=True),
